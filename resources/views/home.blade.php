        ...
        <div class="col-span-12 xl:col-span-4 md:col-span-6">
            <div class="card">
                <div class="card-header !pb-0 !border-b-0">
                    <h5>Qtde Ovos Produzidos</h5>
                </div>
                <div class="card-body">
                    <div class="flex items-center justify-between gap-3 flex-wrap">
                        <h3 class="font-light flex items-center mb-0">
                            <i class="feather icon-arrow-up text-success-500 text-[30px] mr-1.5"></i>
                            {{ $dados['result']['total_ovos'] }}
                        </h3>
                        <p class="mb-0">{{ number_format($dados['result']['percentualProducao'], 2, ',', '.') }} %</p>
                    </div>
                    <div class="w-full bg-theme-bodybg rounded-lg h-1.5 mt-6 dark:bg-themedark-bodybg">
                        <div class="bg-theme-bg-1 h-full rounded-lg shadow-[0_10px_20px_0_rgba(0,0,0,0.3)]"
                            role="progressbar" style="width: {{ (int) $dados['result']['percentualProducao'] }}%"></div>
                    </div>
                </div>
            </div>
        </div>
