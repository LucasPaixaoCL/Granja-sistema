<x-layout-app page-title="Núcleos [Editar]">
    ...
    <form action="{{ route('nucleos.update') }}" method="post">
        @csrf
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="descricao" name="descricao" required
                                    value="{{ old('descricao', $dados['nucleo']->descricao ?? '') }}">
                                @error('descricao')
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="area_total" name="area_total" required
                                    value="{{ old('area_total', $dados['nucleo']->area_total ?? '') }}">
                                @error('area_total')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control" name="situacao" id="situacao">
                                    @foreach ($dados['situacoes'] as $situacao)
                                        <option value="{{ $situacao['id'] }}" @selected($situacao['id'] === $dados['nucleo']->situacao)>
                                            {{ $situacao['descricao'] }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mt-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="observacoes" name="observacoes" required
                                    value="{{ old('observacoes', $dados['nucleo']->observacoes ?? '') }}">
                                @error('observacoes')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
